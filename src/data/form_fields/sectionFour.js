export const sectionFour = [
  ...
  },
  {
    ...
    formPlaceholder: 'Provide a brief explanation (Maximum 50000 characters)',
    type: 'string',
    fieldType: 'textarea',
    ...
    instructions: '',
    layout: 'form-explanation bold',
  },
  {
    title: 'Relationship to certified item',
    contentfulFieldName: 'relationship',
    formPlaceholder: 'Provide a brief explanation (50000 characters)',
    type: 'string',
    fieldType: 'input',
    instructions:
